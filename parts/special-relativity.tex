...
Let's imagine there are 2 coordinate systems, $K$ and $k$, both ``at rest" in their own right.

For every event at $(x, y, z, t)$ measured in a system $K$ at rest, there corresponds to a ``fixed" or transformed event
$(\xi, \eta, \zeta, \tau)$ measured in a system $k$ moving in the positive x-direction relative to $K$. This section derives the
relation of $(\xi, \eta, \zeta, \tau)$ = $f(x, y, z, t)$
