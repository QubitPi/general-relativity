...
Now it is our target to focus on the $x$-direction only and it is our intuition that nothing changes in $y$ or $z$
direction, i.e.
...
that Eq.~\ref{eq:transformation},~\ref{eq:x-transformation},~\ref{eq:y-transformation},~\ref{eq:z-transformation} becomes
