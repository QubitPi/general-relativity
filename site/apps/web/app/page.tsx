      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 py-16 md:py-24">
          ...
          >
            ...
            >
              My exploration on the connection between General Relativity and Quantum Mechanics via {' '}
              <span className="text-gradient-purple font-semibold">
                Graph Theory
              </span>{' '}
              in order to see the inside of a Black Hole
            </motion.p>
            ...
            >
              <a
                href="https://github.com/QubitPi/general-relativity"
                target="_blank"
              ...
              <a
                href="https://relativity.qubitpi.org/study-notes.pdf"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <div className="space-y-6">
                <div className="group">
                  <p className="mb-3 text-lg text-slate-300">
                    Getting the source code of my notes:
                  </p>
